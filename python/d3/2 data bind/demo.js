 ...
 ********************************************************** */
var austinTemps = [76, 59, 59, 73, 71];
var selection = d3.select('#content').selectAll('.temps').data(austinTemps);

selection.classed('temps', true);
...
/** *********************************************************
// 5. Exit Pattern - Remove extra element if data is not enough
********************************************************** */
var austinTemps = [76];
...
function update(data) {
  var selection = d3.select('#content').selectAll('.temps').data(data);
